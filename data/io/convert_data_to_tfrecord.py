...
FLAGS2["data_dir"] = os.path.abspath(os.path.join(FLAGS2["root_dir"],'DateSet','RSDDs_dataset_LJ','RSDDsTrain','VOCdevkit2007','VOC2007'))
...
tf.app.flags.DEFINE_string('save_dir', cfgs.ROOT_PATH + '\\data\\tfrecord', 'save name')

tf.app.flags.DEFINE_string('img_format', '.jpg', 'format of image')
tf.app.flags.DEFINE_string('dataset', 'RSDD', 'dataset')
