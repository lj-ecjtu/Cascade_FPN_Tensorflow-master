...
def parse_args():
    ...
    #FLAGS2["data_dir"] = os.path.abspath(os.path.join(FLAGS2["root_dir"],'DateSet','VOC2007','Test','VOCdevkit2007','VOC2007'))
    FLAGS2["data_dir"] = os.path.abspath(os.path.join(FLAGS2["root_dir"],'DateSet','RSDDs_dataset_LJ','RSDDsTest','VOCdevkit2007','VOC2007'))
    ...
    parser.add_argument('--eval_imgs', dest='eval_imgs',
                        ...
                        default=os.path.join(FLAGS2["data_dir"],'JPEGImages'), type=str)
    parser.add_argument('--annotation_dir', dest='test_annotation_dir',
                        help='the dir save annotations',
                        default=os.path.join(FLAGS2["data_dir"],'Annotations'), type=str)
